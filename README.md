...
Or include the script from our CDN in your HTML file using:
    ...
    <script src="//cdn.evrythng.net/toolkit/evrythng-js-sdk/evrythng-2.0.5.min.js"></script>
...
For HTTPs you'll have to use:
    ...
    <script src="//d10ka0m22z5ju5.cloudfront.net/toolkit/evrythng-js-sdk/evrythng-2.0.5.min.js"></script>
